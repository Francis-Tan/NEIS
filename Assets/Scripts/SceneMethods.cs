...
public class SceneMethods : MonoBehaviour {
    /** 
     * For each button, We could also change renderer.material.color 
     * using OnMouseEnter() OnMouseExit() OnMouseClick()
     */
    ...
    public void PlayTutorial() {
        Player.GetInstance().Spawn(new Vector2(-0.8f, -1.8f), 50, 0, 0, false);
    ...
    public static void LoadCheckPointLevel(int FloorNumber, CheckPointManager.PlayerData playerData) {
        ...
        Player.GetInstance().Spawn(MainLevelPos,
